package de.thkoeln.fherborn.fearlesschange.v2.helper.animation
...
class FlipAnimationHelper(private val front: View, private val back: View, showBackFirst: Boolean = false) {
